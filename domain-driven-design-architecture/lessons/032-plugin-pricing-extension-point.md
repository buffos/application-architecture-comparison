...
Quoting owns the pricing-policy contract because pricing creates Quoting values. The application can provide another policy, such as a seasonal discount, while the QuotePricingService continues to orchestrate the same workflow.
...
- extract a pricing-policy contract
